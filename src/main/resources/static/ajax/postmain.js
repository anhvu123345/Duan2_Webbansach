...
function myClickButton() {
	...
	if (document.getElementById("filea[0]").value != ""
			&& document.getElementById("filec[0]").value != "") {
		$("#formanh1").submit();
		$("#formanh3").submit();
	}
	if (document.getElementById("filea[0]").value != ""
			&& document.getElementById("fileb[0]").value != "") {
		$("#formanh1").submit();
		$("#formanh2").submit();
	}
	if (document.getElementById("filea[0]").value != ""
			&& document.getElementById("filed[0]").value != "") {
		$("#formanh1").submit();
		$("#formanh4").submit();
	}
	if (document.getElementById("fileb[0]").value != ""
	...
	/*
	 * if (document.getElementById("fileb[0]").value != "") {
	 * $("#submit2").click(); } if (document.getElementById("filec[0]").value !=
	 * "") { $("#submit3").click(); } if
	 * (document.getElementById("filed[0]").value != "") {
	 * $("#submit4").click(); }
	 */
